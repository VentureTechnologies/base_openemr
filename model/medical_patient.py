...
class medical_patient(models.Model):    
    ...
    def print_report(self):
        return self.env.ref('base_openemr.report_print_patient_card').report_action(self)
    ...
    current_insurance_certificate = fields.Char(related='current_insurance_id.certificate_number', string="Certificate Number")
    current_insurance_exp = fields.Date(related='current_insurance_id.member_exp', string="Expiration Date")
    ...
    sleep_quality = fields.Selection([('g','Good'),('r','Regular'),('b','Bad')],string='Sleep Quality')
